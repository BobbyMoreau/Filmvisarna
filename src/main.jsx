...
export const pages = [
  ...
  { path: '/minsida', label: 'Min sida', element: <RequireAuth> <MyPage /> </RequireAuth>   },
  { path: '/detaljsidan/:movieId', label: '', element: <MoviePage /> },
  { path: '/finalize-booking', label: '', element: <FinalizeBooking /> },
  { path: '/bokningsbekraftelse', label: '', element: <BookingConfirmation /> },
];
